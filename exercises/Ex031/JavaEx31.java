...
public class JavaEx31{
    ...
    static int TARGET_VALUE = 200;

    public static void main(String[] args) {
      long count_sum_target = 0;

      for(int v200=0; v200<=TARGET_VALUE; v200+=200){
        for(int v100=v200; v100<=TARGET_VALUE; v100+=100){
          for(int v50=v100; v50<=TARGET_VALUE; v50+=50){
            for(int v20=v50; v20<=TARGET_VALUE; v20+=20){
              for(int v10=v20; v10<=TARGET_VALUE; v10+=10){
                for(int v5=v10; v5<=TARGET_VALUE; v5+=5){
                  for(int v2=v5; v2<=TARGET_VALUE; v2+=2){
      ...
      System.out.println(count_sum_target);  // 73,682
    }
